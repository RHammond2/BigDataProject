...
for line in sys.stdin:
	...
	if 'USAF' in line:
		...
		#split pickup date into individual components
		#pickup_date = tpep_pickup[0]
		year = tpep_pickup[:4]
		month = tpep_pickup[5:7]
		day = tpep_pickup[8:10]
		# split pickup time into individual components
		hour = tpep_pickup[11:13]
		minute = tpep_pickup[14:16]
		second = tpep_pickup[17:]
