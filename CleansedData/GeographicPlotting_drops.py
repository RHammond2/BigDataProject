...
df = dd.read_csv('drops_webmerc',names=['p_d_status','time','long','lat','web_long','web_lat','temp','PCP01','passenger_count',                                 'trip_distance','tip_amount','tolls_amount','total_amount'])
